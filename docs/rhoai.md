...
3) Access the `workbench` named `test-codegen-helm-181204-notebook`
...
5) In the terminal, run `cd test-codegen-helm-181204` to navigate to your sample app's directory
